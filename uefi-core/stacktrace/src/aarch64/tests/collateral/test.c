//
// C test code to load the aarch64.dll in to memory and orchestrate the call stack.
//
...
GetCurrentRip get_current_pc = NULL;
GetReturnRip get_return_pc = NULL;
GetCurrentRsp get_current_sp = NULL;
...
int main() {
    ...
    get_current_pc = (GetCurrentRip)GetProcAddress(dll, "GetCurrentRip");
    if (!get_current_pc) {
    ...
    get_return_pc = (GetReturnRip)GetProcAddress(dll, "GetReturnRip");
    if (!get_return_pc) {
    ...
    get_current_sp = (GetCurrentRsp)GetProcAddress(dll, "GetCurrentRsp");
    if (!get_current_sp) {
