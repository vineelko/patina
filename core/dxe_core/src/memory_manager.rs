...
#[uefi_test]
fn memory_manager_allocations_test(mm: Service<dyn MemoryManager>) -> uefi_test::Result {
...
#[uefi_test]
fn memory_manager_attributes_test(mm: Service<dyn MemoryManager>) -> uefi_test::Result {
