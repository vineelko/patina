//! [`Uart16550`] — a 16550 UART [`SerialIO`](crate::serial::SerialIO) implementation.
//!
//! ## License
//!
...
/// [`SerialIO`](crate::serial::SerialIO) methods guarantees exclusive use of the device, so no
...
impl crate::serial::SerialIO for Uart16550 {
    fn init(&mut self) {
        match self {
