...
impl ProtocolNotify {
    ...
    pub unsafe fn invoke(&self, protocol: &efi::Guid, interface: *mut c_void, handle: efi::Handle) -> efi::Status {
        match self {
            ...
            Self::Efi(callback) => unsafe { callback(core::ptr::from_ref(protocol), interface, handle) },
        }
    }
}
...
/// [`BootServices`](crate::uefi::boot_services::BootServices).
...
///
/// This is the MM analogue of
/// [`StandardBootServices`](crate::uefi::boot_services::StandardBootServices) in the
