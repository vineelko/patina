...
/// ```
/// # use patina::guid::EVENT_EXIT_BOOT_SERVICES;
/// # assert_eq!("27ABF055-B1B8-4C26-8048-748F37BAA2DF", format!("{}", EVENT_EXIT_BOOT_SERVICES));
/// ```
...
/// ```
/// # use patina::guid::EVENT_GROUP_END_OF_DXE;
...
/// ```
/// # use patina::guid::EVENT_READY_TO_BOOT;
/// # assert_eq!("7CE88FB3-4BD7-4679-87A8-A8D8DEE50D2B", format!("{}", EVENT_READY_TO_BOOT));
/// ```
...
/// ```
/// # use patina::guid::HARDWARE_INTERRUPT_PROTOCOL;
...
/// ```
/// # use patina::guid::HARDWARE_INTERRUPT_PROTOCOL_V2;
...
/// ```
/// # use patina::guid::MEMORY_TYPE_INFORMATION;
...
/// ```
/// # use patina::guid::MM_DISPATCH_EVENT;
/// # assert_eq!("7E6EFFFA-69B4-4C1B-A4C7-AFF9C9244FEE", format!("{}", MM_DISPATCH_EVENT));
/// ```
...
/// ```
/// # use patina::guid::MM_DXE_READY_TO_LOCK_PROTOCOL;
/// # assert_eq!("60FF8964-E906-41D0-AFED-F241E974E08E", format!("{}", MM_DXE_READY_TO_LOCK_PROTOCOL));
/// ```
...
/// ```
/// # use patina::guid::MM_END_OF_DXE_PROTOCOL;
/// # assert_eq!("24E70042-D5C5-4260-8C39-0AD3AA32E93D", format!("{}", MM_END_OF_DXE_PROTOCOL));
/// ```
...
/// ```
/// # use patina::guid::MM_END_OF_PEI_PROTOCOL;
/// # assert_eq!("F33E1BF3-980B-4BFB-A29A-B29C86453732", format!("{}", MM_END_OF_PEI_PROTOCOL));
/// ```
...
/// ```
/// # use patina::guid::MM_READY_TO_LOCK_PROTOCOL;
/// # assert_eq!("47B7FA8C-F4BD-4AF6-8200-333086F0D2C8", format!("{}", MM_READY_TO_LOCK_PROTOCOL));
/// ```
...
/// ```
/// # use patina::guid::PERFORMANCE_PROTOCOL;
...
/// ```
/// # use patina::guid::SMM_COMMUNICATION_PROTOCOL;
...
/// ```
/// # use patina::guid::HOB_MEMORY_ALLOC_STACK;
...
/// ```
/// # use patina::guid::HOB_LIST;
/// # assert_eq!("7739F24C-93D7-11D4-9A3A-0090273FC14D", format!("{}", HOB_LIST));
/// ```
