...
//!
//! GUID constants used for common and generic events between drivers. Some are defined by the UEFI/PI
//! specifications and re-exported here for convenience; others are Patina-specific and not defined in any
...
use crate::base::guid::OwnedGuid;

/// Zero GUID constant (`00000000-0000-0000-0000-000000000000`) as an [`OwnedGuid`].
...
/// ```
/// # use patina::base::guid::constants::DXE_CORE;
...
/// ```
/// # use patina::base::guid::constants::EBS_FAILED;
...
/// ```
/// # use patina::base::guid::constants::EDKII_FPDT_EXTENDED_FIRMWARE_PERFORMANCE;
...
/// ```
/// # use patina::{Guid, base::guid::constants::EVENT_EXIT_BOOT_SERVICES};
...
/// ```
/// # use patina::{Guid, base::guid::constants::EVENT_READY_TO_BOOT};
...
/// ```
/// # use patina::base::guid::constants::HARDWARE_INTERRUPT_PROTOCOL;
...
/// ```
/// # use patina::base::guid::constants::HARDWARE_INTERRUPT_PROTOCOL_V2;
...
/// ```
/// # use patina::base::guid::constants::MEMORY_TYPE_INFORMATION;
...
/// ```
/// # use patina::{Guid, base::guid::constants::MM_DISPATCH_EVENT};
...
/// ```
/// # use patina::{Guid, base::guid::constants::MM_DXE_READY_TO_LOCK_PROTOCOL};
...
/// ```
/// # use patina::{Guid, base::guid::constants::MM_END_OF_DXE_PROTOCOL};
...
/// ```
/// # use patina::{Guid, base::guid::constants::MM_END_OF_PEI_PROTOCOL};
...
/// ```
/// # use patina::{Guid, base::guid::constants::MM_READY_TO_LOCK_PROTOCOL};
...
/// ```
/// # use patina::base::guid::constants::PERFORMANCE_PROTOCOL;
...
/// ```
/// # use patina::base::guid::constants::SMM_COMMUNICATION_PROTOCOL;
...
/// ```
/// # use patina::base::guid::constants::HOB_MEMORY_ALLOC_STACK;
...
/// ```
/// # use patina::{Guid, base::guid::constants::HOB_LIST};
