...
//!
//! This benchmark compares the performance of patina_sdk::Guid wrapper operations
...
//!
//! `> cargo make bench -p patina_sdk --bench bench_guid`
//!
//! If you wish to run a subset of benchmarks in this file, you can filter them by name:
//!
//! `> cargo make bench -p patina_sdk --bench bench_guid -- <filter>`
//!
//! ## Examples
//!
//! ```bash
//! > cargo make bench -p patina_sdk --bench bench_guid -- guid_creation
//! > cargo make bench -p patina_sdk --bench bench_guid -- guid_display
//! > cargo make bench -p patina_sdk --bench bench_guid -- guid_comparison
//! > cargo make bench -p patina_sdk --bench bench_guid -- guid_complex_operations
//! > cargo make bench -p patina_sdk --bench bench_guid
//! ```
//!
...
use patina_sdk::base::guid::{Guid, OwnedGuid};
use r_efi::efi;
