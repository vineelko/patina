...
//!
//! See [IntoService][patina_sdk_macro::IntoService] macro for more information on how to implement a service. While the
...
pub trait IntoService {
    ...
    ///
    /// use alloc::boxed::Box;
    /// use patina_sdk::component::{Storage, service::IntoService};
    ///
    /// struct MyStruct;
    ///
    /// trait Service {}
