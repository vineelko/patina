...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("23C9322F-2AF2-476A-BC4C-26BC88266C71", format!("{:?}", Guid(&DXE_CORE)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("4F6C5507-232F-4787-B95E-72F862490CB1", format!("{:?}", Guid(&EBS_FAILED)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("3B387BFD-7ABC-4CF2-A0CA-B6A16C1B1B25", format!("{:?}", Guid(&EDKII_FPDT_EXTENDED_FIRMWARE_PERFORMANCE)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("02CE967A-DD7E-4FFC-9EE7-810CF0470880", format!("{:?}", Guid(&EVENT_GROUP_END_OF_DXE)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("2890B3EA-053D-1643-AD0C-D64808DA3FF1", format!("{:?}", Guid(&HARDWARE_INTERRUPT_PROTOCOL)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("32898322-2DA1-474A-BAAA-F3F7CF569470", format!("{:?}", Guid(&HARDWARE_INTERRUPT_PROTOCOL_V2)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("4C19049F-4137-4DD3-9C10-8B97A83FFDFA", format!("{:?}", Guid(&MEMORY_TYPE_INFORMATION)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("76B6BDFA-2ACD-4462-9E3F-CB58C969D937", format!("{:?}", Guid(&PERFORMANCE_PROTOCOL)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("C68ED8E2-9DC6-4CBD-9D94-DB65ACC5C332", format!("{:?}", Guid(&SMM_COMMUNICATION_PROTOCOL)));
/// ```
...
/// ```
/// # use patina_sdk::Guid;
/// # assert_eq!("00000000-0000-0000-0000-000000000000", format!("{:?}", Guid(&ZERO)));
/// ```
