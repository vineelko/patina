...
pub trait MmCommunication {
    ...
    /// ```rust
    /// use r_efi::efi;
    /// use uefi_sdk::component::service::{mm_communicator::MmCommunication, Service};
    ///
...
mod tests {
    ...
    use uefi_sdk::component::service::sw_mmi_manager::MockSwMmiTrigger;
    ...
    fn test_communicate_sw_mmi_is_returns_mmi_error() {
        ...
        // Verify that a software MMI that fails returns `uefi_sdk::component::service::mm_communicator::StatusSwMmiFailed`
