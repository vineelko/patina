...
pub(crate) fn component2(item: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        impl #lhs uefi_sdk::component::params::ComponentInput for #name #rhs #where_clause {}
        impl #lhs uefi_sdk::component::IntoComponent<fn(#name #rhs)-> uefi_sdk::error::Result<()>> for #name #rhs #where_clause {
            fn into_component(self) -> #alloc_name::boxed::Box<dyn uefi_sdk::component::Component> {
